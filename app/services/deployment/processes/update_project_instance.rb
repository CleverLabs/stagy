  ...
  module Processes
    class UpdateProjectInstance
      ...
      def call
        ...
        ServerActionsCallJob.perform_later(Deployment::ServerActions::Update.to_s, configurations, logger, @project_instance, Constants::ProjectInstance::UPDATING.to_s)
      end
    end
  end
end
