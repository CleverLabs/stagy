...
module GitlabIntegration
  class RepositoriesController < ::ApplicationController
    ...
    def repository_params
      params.require(:repository).permit(:integration_id, :runtime_env_variables, :build_env_variables, :build_type, addon_ids: [], web_processes_attributes: %i[id name command])
    end
